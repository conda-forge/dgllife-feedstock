...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dgllife-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14272&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dgllife-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dgllife` can be installed with:

```
conda install dgllife
```

It is possible to list all of the versions of `dgllife` available on your platform with:
